...
App de agendamento de serviços de barbearia.
...
- O usuário deve poder recuperar sua senha informação o seu e-mail;
...
- O usuário deve poder listar os dias de um mês com pelo menos um hoário disponível de um prestador;
